        ...
        steps {
            sshagent(['ssh-remote-reactivities']) {
                ...
                sh 'ssh -o StrictHostKeyChecking=no -l phuchoquang ${REACTIVITIES_SERVER} docker image rm --force 37180/reactivities-fe'
                 ...
                 sh 'ssh -o StrictHostKeyChecking=no -l phuchoquang ${REACTIVITIES_SERVER} docker run -p 3000:3000 -d --rm --name client --network reactivities 37180/reactivities-fe bash'
